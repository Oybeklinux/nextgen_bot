        ...
        inline_keyboard=[
            [
                ...
                InlineKeyboardButton(text=await _("iopen_lesson_vip"),
                                     callback_data=general_cb.new(course=course, submenu='register_to_open_lesson_vip',
                                                                  is_menu='')),
                InlineKeyboardButton(text=await _("iget_in_touch"),
                                     url='https://t.me/kamilaa3')],
            [InlineKeyboardButton(text=await _("icourse_content"),
                                  callback_data=general_cb.new(submenu="course_content", course=course, is_menu='')),
             InlineKeyboardButton(text=await _("icourse_objective"),
                                  callback_data=general_cb.new(submenu="course_objective", course=course,
                                                               is_menu=''))],
